            ...
            <div className='main-content container-fluid'>
                ...
                <div className='main-heading-section row'>
                    ...
                    <div className='col-lg-7 col-sm-12'>
                        <div className='main-heading-second mb-4 selectable'>
                            Attract Your Visitors Attention With Colorful <span className='gradient-color'> Motion Art Effect</span>
                        </div>
                        <div className='grey-text grey-text-first-heading selectable'>Unleash the power of creativity with Motion Art for Elementor - your ultimate solution for seamlessly integrating captivating animations into your website. </div>
                    </div>
                </div>
                <div className='text-align-center grey-white-color grey-white-first-heading my-5 selectable'>Trusted by thousands of users around the world</div>
                <div className='reviews row'>
                    <div className='col-lg-4 col-sm-12 selectable'>
                ...
                <div className='magical-wand-section row my-5'>
                    <div className='col-lg-8 col-sm-12'>
                        <div className='grey-white-color grey-white-third-heading selectable'>Turn Your Cursor Into A Colorful Magic Wand & Charm Your Visitors</div>
                        <div className='grey-text grey-text-first-heading selectable'>Motion Art for Elementor is a groundbreaking plugin that empowers you to effortlessly infuse your website with visually stunning motion art elements.</div>
                        <button className='btn gradient-background wand-button py-3 my-3 selectable'>Purchase From Envato<i class="fa-solid fa-arrow-right"></i></button>
                    </div>
                    <div className='col-lg-4 col-sm-12 magical-wand selectable'><img src={wand} /></div>
                </div>
                <div className='grey-white-color grey-white-third-heading text-align-center my-5 selectable'>
                ...
                <div className='features-div mb-5 selectable'>
